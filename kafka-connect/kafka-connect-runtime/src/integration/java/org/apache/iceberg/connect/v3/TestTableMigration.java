...
public class TestTableMigration extends IntegrationTestBaseV3 {
    ...
    public void testMigration(boolean useSchema) {
        ...
        List<StructEvent> fullEventsList = Stream.concat(KAFKA_EVENTS.stream(), Stream.of(newEvent)).toList();
    ...
    private List<org.apache.iceberg.data.Record> castEventsToRecords(Table table, List<StructEvent> kafkaEvents) {
