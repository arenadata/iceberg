...
/**
 * {@link DataComplete} as released before it had {@code task_id}, renamed: the reader of a
 * connector one version behind. Keep it as it is; it must not follow changes to {@link
 * DataComplete}.
 */
public class LegacyDataComplete implements Payload {
  ...
  private static final Schema AVRO_SCHEMA =
      AvroUtil.convert(ICEBERG_SCHEMA, LegacyDataComplete.class);

  // Used by Avro reflection to instantiate this class when reading events
  public LegacyDataComplete(Schema avroSchema) {
    this.avroSchema = avroSchema;
  }

  public LegacyDataComplete(UUID commitId, List<TopicPartitionOffset> assignments) {
